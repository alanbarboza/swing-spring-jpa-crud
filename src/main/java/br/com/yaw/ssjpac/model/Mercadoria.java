...
public class Mercadoria implements Persistable<Integer> {

	private static final long serialVersionUID = 4958275841175711616L;

	@Id
	@Column(name = "co_seq_mercadoria", nullable = false)
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private Integer id;

	@NotNull
	@Size(min = 5, max = 200)
	@Column(name = "no_mercadoria")
	private String nome;
